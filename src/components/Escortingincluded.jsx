              ...
              <div className="row main-services own-dementiaincluded">
                ...
                <div className="col-3 all-services dementiasser">
                  ...
                  <div className="ser-text innerpage texted">
                    ...
                    <h3>Personal Assistance During Travel </h3>
                    <p className='allp serp'>Personal assistance during travel ensures that clients move safely and comfortably whenever they leave home. Caregivers help with entering and exiting vehicles, provide support for walking or using mobility aids, and offer guidance to those with limited mobility.</p>
